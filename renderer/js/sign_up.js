...
document.addEventListener('DOMContentLoaded', () => {
    ...
    signupForm.addEventListener('submit', (e) => {
        ...
        const url = `https://al-maher.net/ar/demo_rest_api/demo_resource?_format=json&code=1183118037061&pid=66&flags=register&userName=${username}&userEmail=${email}&userFullName=${fullName}&userPhone=${mobile}&userPassword=${password}&time=1695671655`;
